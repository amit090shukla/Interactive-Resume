  ...
  public render() {
    return (
      <div>
        ...
        <div className="d-f-c" style={{ justifyContent: "space-between" }}>
          ...
          <div style={workContainerStyle}>
            ...
            <span>
              ...
              at the backend.
              <ul>
                <li>Implemented routing on the website using React Router. </li>
                <li>
                  Optimized the website load time by using concepts like sprite
                  images to reduce server requests and Lazyload for content
                  heavy sections.{" "}
                </li>
                <li>Implemented social login buttons (Google and Facebook).</li>
                <li>
                ...
                <li>
                  ...
                  no. of server requests also went down to 102 from 120 for the
                  landing page after switching to React{" "}
                </li>
                <li>
